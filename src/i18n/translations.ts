...
const en: Translation = {
  ...
  howToPlayText: "Tap Start and the timer begins: you have 1 minute to find both words. Swipe from the word's first letter to its last, in a straight line (horizontal, vertical or diagonal). If time runs out, you move to the next round in 5 seconds. Complete all 7 rounds to finish the day.",
...
const fr: Translation = {
  ...
  howToPlayText: "Appuie sur Commencer et le chronomètre démarre : tu as 1 minute pour trouver les deux mots. Glisse depuis la première lettre du mot jusqu'à la dernière, en ligne droite (horizontale, verticale ou diagonale). Si le temps est écoulé, tu passes à la manche suivante dans 5 secondes. Termine les 7 manches pour finir la journée.",
...
const de: Translation = {
  ...
  howToPlayText: "Tippe auf Start und der Timer läuft los: Du hast 1 Minute, um beide Wörter zu finden. Wische vom ersten bis zum letzten Buchstaben des Wortes in gerader Linie (horizontal, vertikal oder diagonal). Läuft die Zeit ab, geht es in 5 Sekunden zur nächsten Runde. Schließe alle 7 Runden ab, um den Tag zu beenden.",
